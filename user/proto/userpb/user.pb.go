...
func (x *GetUserResponse) GetAvatarUrl() *wrapperspb.StringValue {
	if x != nil {
		return x.AvatarUrl
	}
	return nil
...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x06userpb\x1a\x1egoogle/protobuf/wrappers.proto\")\n" +
	...
	"\n" +
	"avatar_url\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\tavatarUrl2I\n" +
	"\vUserService\x12:\n" +
	"\aGetUser\x12\x16.userpb.GetUserRequest\x1a\x17.userpb.GetUserResponseB\x13Z\x11user/proto/userpbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	2, // 0: userpb.GetUserResponse.avatar_url:type_name -> google.protobuf.StringValue
